...
void Boid::avoid_walls(const glm::vec2& min_window_size, const glm::vec2& max_window_size, const float& wall_distance)
{
    glm::vec2 force(0.0f);
...
{
    glm::vec2 average_position(0.0f);
    ...
    if (count > 0)
    {
        ...
        const glm::vec2 direction_to_target = average_position - m_position;
